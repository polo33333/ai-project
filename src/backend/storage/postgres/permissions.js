...
async function grantRuntime(pool) {
  ...
  for (const table of [...tables,'domain_stores','operation_commits','chat_request_receipts','worker_leases','outbox_jobs','ui_chat_sessions','workflow_catalog','automation_runs']) {
